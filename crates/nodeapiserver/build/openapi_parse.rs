...
pub fn parse_all(root: &Path) -> (Vec<FieldMeta>, Vec<GvkEntry>, Vec<RequiredField>) {
    ...
    let required = required
        ...
        .collect();
    (field_meta.into_values().collect(), gvks, required)
}
...
pub fn render(field_meta: &[FieldMeta], gvks: &[GvkEntry], required: &[RequiredField]) -> String {
