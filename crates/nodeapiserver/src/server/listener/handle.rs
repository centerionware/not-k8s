...
async fn handle(
    ...
    handle_subresources!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
    handle_patch!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
    handle_status!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
    handle_delete_collection!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
    handle_reviews!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
    handle_tokens!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
    handle_scale!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
    handle_aggregate!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
    handle_crud!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
    return handle_watch!(req, storage, cache_registry, pure_admission, pod_node_selector_config, identity, service_account_authenticator, enforce_rbac, authorization_webhook_allowed, aggregation_proxy_identity, kubelet_tls, method, path_str, query, info, request_field_manager, admission_metadata, is_get, is_list, is_create, is_delete, is_update, is_watch, is_certificate_status_subresource, wants_partial_metadata, has_body);
}
