...
- Source: `4a502851d05bf09d6bef39b7c86d68dfc2328c35`
- Run: https://github.com/centerionware/not-k8s/actions/runs/33936850226
- Build: profiling; capture result: capture=success,render=success
- Workload: heavy (see workload-config.json for parameters)
- Complete compressed bundle: 112151463 bytes; parts are below GitHub's per-file limit.
