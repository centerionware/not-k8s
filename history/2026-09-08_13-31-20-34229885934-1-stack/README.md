...
- Run: https://github.com/centerionware/not-k8s/actions/runs/34229885934
- Build: profiling; capture result: capture=success,render=success
- Workload: heavy (see workload-config.json for parameters)
- Complete compressed bundle: 100072619 bytes; parts are below GitHub's per-file limit.
...
- [load/nodeproxy/flamegraph.svg](load/nodeproxy/flamegraph.svg)
