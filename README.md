...
```
wget https://github.com/centerionware/not-k8s/releases/download/v0.7.2.1/notk8s-0.7.2.1-linux-aarch64-release
chmod +x notk8s-0.7.2.1-linux-aarch64-release
ln -s ./notk8s-0.7.2.1-linux-aarch64-release bootstrap
./bootstrap
```
