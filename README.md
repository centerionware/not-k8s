...
[Release](https://github.com/centerionware/not-k8s/releases/tag/v0.8.0) · [Workflow](https://github.com/centerionware/not-k8s/actions/runs/34225806745)
...
[Full e2e shard logs](e2e/34225806745-1/)

[Latest stack flamegraphs](latest-stack.md)

[Latest three-way comparison](latest-comparison.md)

[This attempt's comparison data](comparisons/34225806745-1/)
