...
- [k3s metadata](k3s/metadata.txt), [workload](k3s/workload.json), [idle CSV](k3s/idle/timeseries.csv), [load CSV](k3s/load/timeseries.csv)
...
### idle-k3s-cpu_pct_one_core

![idle-k3s-cpu_pct_one_core](charts/idle-k3s-cpu_pct_one_core.png)

### idle-k3s-pss_kib

![idle-k3s-pss_kib](charts/idle-k3s-pss_kib.png)

### idle-k3s-rss_kib

![idle-k3s-rss_kib](charts/idle-k3s-rss_kib.png)
...
### load-k3s-cpu_pct_one_core

![load-k3s-cpu_pct_one_core](charts/load-k3s-cpu_pct_one_core.png)

### load-k3s-pss_kib

![load-k3s-pss_kib](charts/load-k3s-pss_kib.png)

### load-k3s-rss_kib

![load-k3s-rss_kib](charts/load-k3s-rss_kib.png)
