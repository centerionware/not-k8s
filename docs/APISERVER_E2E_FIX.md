...
| DRA workload startup | open | Earlier shard 2 DRA/raw-block/fsGroup timeouts were observed alongside broader startup failures. CSI is now isolated and passing; run the DRA tests independently before attributing the remaining issue to nodeapiserver. | — |
