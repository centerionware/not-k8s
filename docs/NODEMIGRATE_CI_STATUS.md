...
| 2026-09-25 | Follow-up to `7899ac9e1d2d6140d4b799bf64beed1657ac6c1c` | Fixture scheduling and Gateway API correction | Gateway listener is changed to Traefik's advertised port 8080. Workload fixture containers now request 1m CPU/1Mi memory. Failure diagnostics now include node allocation and blocked seed/standalone/nginx Pod descriptions. Shell syntax, snapshot-filter, and diff checks are pending; migration rerun is pending. | Not dispatched yet |
