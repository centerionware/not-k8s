...
| Follow-up to `c56d3f3ecce3a43339ba0df23aec02a36193d841` | nodeapiserver map-key CEL | Treat typed additionalProperties schemas as CEL maps and cost single-variable map comprehensions by bounded key iteration. Added type and static-cost regressions for Gateway API annotation rules. The focused nodeapiserver quick-check now passes; branch-runtime validation for this implementation is running. | Implementation at `6a2e99d6`; tests [36148848411](https://github.com/centerionware/not-k8s/actions/runs/36148848411); migration [36148384987](https://github.com/centerionware/not-k8s/actions/runs/36148384987) |
