...
| Follow-up to `36fb2e70852ef4711db60128d29c483b115e41dc` | nodeapiserver CEL global `matches` | Register Kubernetes' global regex `matches(string, regex)` and add a safe-upgrades expression regression. Source fixture issue is resolved; focused nodeapiserver CI and branch/release runtime retests are pending. | Not dispatched yet |
