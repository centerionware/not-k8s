...
| Follow-up to `de7d79333131c566dd1260e9cdcbcf159d8a33a4` | RBAC Node-read Job manifest | The heredoc now escapes `$(NODE_NAME)` for evaluation inside the Job container. Shell/snapshot/diff checks and migration rerun pending. | Not dispatched yet |
