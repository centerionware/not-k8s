...
| Follow-up to `89ffb03f46f29dec02b9fb3cff5cf22a3c127013` | Secret jq key selection | The fixture now selects `.data["migration-secret"]`. Shell/snapshot/diff checks and migration rerun pending. | Not dispatched yet |
