...
| Follow-up to `b67692295b72763f5706d59774bda7d6527f51eb` | Source fixture stage initialization | `install_workloads` now sets the fixture stage to `source` before source assertions run. Shell/snapshot/diff checks and migration rerun pending. | Not dispatched yet |
