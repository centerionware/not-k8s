...
| Follow-up to `4c05f5c73b9fb77e65783540e6766fd2ec56a544` | PriorityClass default handling | The PriorityClass assertion now treats omitted `globalDefault` as false, consistent with API defaulting/serialization. Shell/snapshot/diff checks and migration rerun pending. | Not dispatched yet |
