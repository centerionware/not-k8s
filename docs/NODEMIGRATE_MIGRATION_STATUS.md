...
| 2026-09-25 | Follow-up to `b67692295b72763f5706d59774bda7d6527f51eb` | Source fixture stage initialization | `install_workloads` now initializes `stage=source` before fixture assertions. This is test-harness work only; runtime migration remains unverified pending rerun. | Not dispatched yet |
