...
| --- | --- | --- | --- | --- |
| 2026-09-26 | `7c5f2935146647c045f3f27d0d3dc9317ebfc9ed` | Branch-runtime K3s+Cilium and upstream Kubernetes+Cilium | Migration rerun pending after replacing the false-positive exact-object-hash gate with source identity retention plus explicit fixture-state comparison. Docker preflight passed; both migration lanes are running. Snapshot filter also classifies CiliumEndpoint/CiliumIdentity as regenerated and retains CiliumNode for migration. | [Run 36257337049](https://github.com/centerionware/not-k8s/actions/runs/36257337049) |
