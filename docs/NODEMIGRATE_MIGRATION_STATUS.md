...
| 2026-09-25 | Follow-up to `f2d2c7639b78ee1a1cb9b6609903e6374fb24716` | HTTPRoute condition wait correction | The integration fixture now polls `.status.parents[].conditions[]` for `Accepted` and `ResolvedRefs` and captures route status on timeout. This is test harness only; migration runtime remains unverified pending rerun. | Not dispatched yet |
