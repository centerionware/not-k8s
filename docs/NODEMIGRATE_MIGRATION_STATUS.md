...
| 2026-09-24 | `1c42edc60fe45a5af654dd3a3f6d055047eacaff` | K3s+Cilium migration | The source-stage workload/data checks and unattended warning passed. Target bootstrap nevertheless enabled flanneld, which failed to acquire a subnet. Logs show an inactive `10-flannel.conflist.cilium_bak` beside the active Cilium config; the CNI detector was matching the backup filename. Detection now filters to CNI config extensions and has a focused regression test. | [Run 36046899524](https://github.com/centerionware/not-k8s/actions/runs/36046899524) |
...
| Worktree after `1c42edc6` | — | Follow-up | Corrects malformed YAML in the Tokio-context regression; its test passed at `65e212ec`. Filters inactive backup files out of CNI detection. The upstream 6443 handoff is still being traced. | [Focused test run 36048275119](https://github.com/centerionware/not-k8s/actions/runs/36048275119) |
