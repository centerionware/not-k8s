...
| Worktree after `1c42edc6` | — | Follow-up | Corrects the malformed YAML in the Tokio-context regression. The exact reason K3s detection chose flannel and the upstream 6443 handoff are still being traced. | — |
